    ...
    >
      ...
      >
        ...
        <div className="bg-gradient-to-r from-purple-600 to-indigo-600 px-6 py-4">
          ...
          {/* Status Badge & Screen Manager Button */}
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              className="bg-white/20 hover:bg-white/30 text-white text-xs px-3 py-1.5 h-auto"
            >
      ...
      {showScreenManager && (
        <ScreenManager onClose={() => setShowScreenManager(false)} />
      )}
    </motion.div>
  );
}
