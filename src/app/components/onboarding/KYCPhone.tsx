      ...
      >
        <div className="bg-white rounded-3xl p-6 shadow-md mb-6">
          ...
          <input
            ...
            disabled
            className="w-full h-14 rounded-2xl bg-gray-50 border border-gray-300 px-4"
          />
          {verified && (
            <motion.div
        ...
        {!verified && (
          <button
            ...
            className="w-full h-14 rounded-full bg-gradient-to-r from-green-500 to-blue-600 hover:from-green-600 hover:to-blue-700 text-white shadow-lg mb-4 font-semibold transition-all"
          >
        ...
        {verified && (
          <button
            onClick={onNext}
            className="w-full h-14 rounded-full bg-gradient-to-r from-green-500 to-blue-600 hover:from-green-600 hover:to-blue-700 text-white shadow-lg font-semibold transition-all"
          >
