      ...
      <div className="space-y-6">
        ...
        <div className="flex gap-4">
          {currentSlide > 0 && (
            <button
              onClick={handlePrev}
              className="flex-1 h-14 rounded-full border border-gray-300 bg-white text-gray-800 hover:bg-gray-50 font-semibold transition-all flex items-center justify-center"
            >
          ...
          <button
            onClick={handleNext}
            className={`${currentSlide === 0 ? 'w-full' : 'flex-1'} h-14 rounded-full bg-gradient-to-r ${slides[currentSlide].gradient} hover:opacity-90 text-white shadow-lg font-semibold transition-all flex items-center justify-center`}
          >
