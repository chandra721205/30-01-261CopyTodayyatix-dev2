    ...
    <div className="min-h-screen w-full max-w-[375px] mx-auto flex flex-col bg-gradient-to-b from-green-50 to-blue-50 p-6">
      ...
      >
        <div className="mb-8 flex gap-2">
          {[0, 1, 2, 3, 4, 5].map((index) => (
            <input
              ...
              className="w-12 h-14 text-xl text-center border-2 border-gray-300 rounded-2xl bg-white focus:border-blue-500 focus:outline-none"
            />
          ))}
        </div>
        ...
        <button
          ...
          className="w-full h-14 rounded-full bg-gradient-to-r from-green-500 to-blue-600 hover:from-green-600 hover:to-blue-700 text-white shadow-lg disabled:opacity-50 font-semibold transition-all"
        >
          Verify & Continue
        </button>
      </motion.div>
