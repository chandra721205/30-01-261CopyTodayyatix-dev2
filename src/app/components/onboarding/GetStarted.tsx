    ...
    <div className="min-h-screen w-full max-w-[375px] mx-auto flex flex-col bg-gradient-to-b from-blue-50 to-purple-50 p-6">
          ...
          >
            ...
            {!granted[index] ? (
              <button
                ...
                className="w-full rounded-full border border-gray-300 bg-white text-gray-800 hover:bg-gray-50 px-4 py-2 font-semibold transition-all"
              >
                Allow
              </button>
            ) : (
      ...
      >
        <button
          onClick={onComplete}
          disabled={!allGranted}
          className="w-full h-14 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white shadow-lg disabled:opacity-50 font-semibold transition-all"
        >
          Start Exploring
        </button>
        <button
